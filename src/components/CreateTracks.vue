            ...
            <form class="mb-4">
                <div class="mb-6">
                    <label for="tracktitle"
                        class="required block mb-2 text-left text-sm font-medium text-gray-900 dark:text-gray-300">Track
                        Title</label>
                    <input type="text" id="tracktitle" v-model="track.title" 
                ...
                <div class="mb-6">
                    <label for="countries"
                        class="block mb-2 text-sm text-left font-medium text-gray-900 dark:text-gray-400 required">Select
                        an album</label>
                    <select v-on:change="onChange($event)" id="countries" required
                        ...
                        <option :value="album.id" v-for="album in albums" :key="album.id" :album="album">{{ album.name }}
                        </option>
                        
                    </select>
                    
                     <p class="invisible peer-invalid:visible text-right text-red-700 font-light text-xs">
