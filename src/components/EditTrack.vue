<template>
    ...
    <div>
        ...
        <h1 class="block text-center text-grey-darkest">Edit Track</h1>
        ...
        <div class="formBg bg-white rounded shadow-lg p-8 m-14">
            ...
            <form class="mb-4">
                ...
                <div class="mb-6">
                    <label for="countries"
                        class="block mb-2 text-sm text-left font-medium text-gray-900 dark:text-gray-400">Select an
                        album</label>
                    <select v-on:change="onChange($event)" id="countries"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                        <option v-if="track.albumId" selected>{{track.albumName}}</option>
                ...
                <div class="mb-6">
                    <label for="default-input"
                        class="block mb-2 text-left text-sm font-medium text-gray-900 dark:text-gray-300">Track
                        URL</label>
                    <input type="text" id="default-input" v-model="track.description"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                </div>
...
export default {
    ...
    methods: {
        ...
        retrieveTrack() {
            TrackDataService.getTrack(this.aid,this.id)
                .then(response => {
